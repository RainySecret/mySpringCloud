...
import com.cloud.way.demotest.sm2.SM2UtilsNew;
...
public class CsvToJson2 {
    ...
    public void ConvertToJson(InputStream filePath, OutputStream outPutPath) throws Exception {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                String encrypted = SM2UtilsNew.encrypt(jsonStr);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //使用Java IO流操作打开/导出文件
        InputStream filePath = new FileInputStream("C:\\Users\\Way\\Desktop\\压测文件\\healthcodeTrail1.csv");
        OutputStream outPutPath = new FileOutputStream("C:\\Users\\Way\\Desktop\\压测文件\\healthcodeTrail3.csv");
